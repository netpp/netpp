...
TcpChannel::TcpChannel(std::weak_ptr<SocketConnectionHandler> connection)
...
std::unique_ptr<ChannelBufferConversion> TcpChannel::createBufferConvertor()
{
	return std::make_unique<TcpChannelConversion>();
}
